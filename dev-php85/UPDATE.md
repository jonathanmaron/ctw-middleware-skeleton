# PHP 8.5.7 Upgrade — `ctw/ctw-middleware-skeleton`
...
> This package is the **template** other `ctw/ctw-middleware-*` packages are
> scaffolded from. Keep its fixes in lock-step with the rest so newly generated
> middleware starts out PHP 8.5-clean.
...
| PHPUnit (`--no-coverage`, stale deps) | 25 tests, 26 assertions, **5 deprecations** (`middlewares/utils`, §2) |
